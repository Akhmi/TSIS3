...
print(above_5_5(movies[0]))  # True if IMDB score is above 5.5
print(movies_above_5_5(movies))  # List of movies with IMDB score above 5.5
print(movies_by_category(movies, 'Romance'))  # List of movies under 'Romance' category
print(average_imdb_score(movies))  # Average IMDB score of all movies
print(average_imdb_score_by_category(movies, 'Romance'))  # Average IMDB score of movies under 'Romance' category
